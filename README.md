...
```javascript
SECONDS_IN_WEEK = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-seconds-in-week@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-seconds-in-week@umd/bundle.js"></script>
```
